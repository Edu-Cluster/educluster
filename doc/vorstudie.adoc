...
=== Einleitung
//TODO Lara: Kritik von Bundschuh einarbeiten
...
//TODO Lara: SWOT Analyse anpassen: Opportunities und Threats = Einflüsse von Außen?
[%SWOT-Analyse,cols=2*]
.SWOT-Analyse
|===
| *Opportunities*
