...
Wie bereits erwähnt wird die Datenbankschicht aus dieser Evaluierung ausgeschlossen. Somit liegt der Fokus auf das Frontend, das Backend und die Schnittstelle.
...
In weiterer Folge ist anzumerken, dass Angular out of the box typensicher ist. TypeScript kann zwar auch mit React und Vue eingesetzt werden, jedoch werden dessen zahlreiche Features nirgends besser genutzt als im Angular. Damit eignet sich dieses Framework für die Entwicklung großer Webapplikationen mit einer komplexen Struktur.

==== Ermittlung der möglichen Backend-Technologien
In diesem Abschnitt werden die drei bekanntesten Backend-Technologien stand 2022footnote:[Vgl. https://www.statista.com/statistics/1124699/worldwide-developer-survey-most-used-frameworks-web/, abgerufen am 30.10.2022] präsentiert, inklusiv eine moderne vierte Option, die sich sowohl als Frontend- als auch als Backend-Technologie kategorisieren lässt.

===== Express.js
Express ist ein auf Node.js basierendes WebFramework, das den serverseitigen Teil einer Webapplikation übernimmt. Es wurde von IBM und Strongloop entwickelt und schließlich im Jahr 2010 veröffentlicht. Die drei beliebtesten Tech-Stacksfootnote:[Vgl. https://www.fingent.com/blog/top-7-tech-stacks-that-reign-software-development/, aufgerufen am 30.10.2022] in der Webentwicklung – MEAN, MERN und MEVN – basieren alle auf Express.
...
Es gibt drei Arten von Renderingfootnote:[Vgl. https://nextjs.org/learn/foundations/how-nextjs-works/rendering, abgerufen am 30.11.2022], die von Next.js unterstützt werden:
...
Damit eine API „RESTful“ gekennzeichnet werden kann, muss sie folgenden Kriterien erfüllenfootnote:[Vgl. https://www.redhat.com/en/topics/api/what-is-a-rest-api, abgerufen am 06.11.2022]:
...
====== Beliebtheit
- Express.js: Express schneidet bei Statistiken über beliebteste JavaScript-Frameworks immer gut abfootnote:[Vgl. https://userguiding.com/blog/javascript-frameworks/, abgerufen am 20.01.2023]. Das bewährte Framework gilt als Standard in Tech-Stacks wie MERN, MEAN und MEVN. Dank dieser Beliebtheit erhält Express die Note 1.
- ASP .NET Core: ASP .NET Core ist nach Express das beliebteste Backend-Frameworkfootnote:[Vgl. https://www.statista.com/statistics/1124699/worldwide-developer-survey-most-used-frameworks-web/, abgerufen am 20.01.2023]. Unternehmen wie Slack und StackOverflow nutzen das Framework. Aus diesen Gründen erhält es die Note 2.
...
Diese Kombination von Technologien ist unter dem Begriff "t3-Stack" bekannt -- ein Technologie-Stapel, der von einem ehemaligen Twitch.tv Softwareingenieur namens Theo Browne popularisiert wurdefootnote:[Vgl. https://github.com/topics/t3-stack, abgerufen am 20.01.2023]. Das Team hat sich für diesen Stapel entschieden, weil er höchst modern ist und von einer ständig wachsenden Entwickler-Gemeinschaft unterstützt wird. Mit diesem Tech-Stack soll EduCluster den Test der Zeit bestehen und die Entwicklung möglichst viel beschleunigen und vereinfachen.
...
Ich entschloss mich aufgrund meiner Erfahrung mit Next.js das Projekt aufzusetzen und unserem GitHub Repository zu initialisieren. Bevor die parallele Entwicklung des gesamten Teams anfing, habe ich auch selbstständig die API entwickelt. Es ist ebenfalls erwähnenswert, dass außer unserem Projekt EduCluster ein kleineres Test-Projekt von mir entwickelt wurde, um die WebUntis-Schnittstelle manuell zu testen und um die automatisierte Tests von Christoph Kiessewetter in Isolation laufen lassen zu können.

Im Bereich der Dokumentenarbeit habe ich bei der Verschriftlichung der Konzeption und Planung des Projekts im Konzeptpapier sowie in der Vorstudie mitgeholfen. Ebenso habe ich bei der Formulierung des Vorworts, der Kurzfassung, des Abstracts, der Einleitung und der Zusammenfassung meine Team-Mitglieder unterstützt.

Darüber hinaus hat die Entwicklung des Frontends den Großteil meiner Zeit in Anspruch genommen. Ich habe in enger Zusammenarbeit mit Lara Kammerer gearbeitet, da sie das Backend übernehmen durfte. Die Aufsetzung von ASCII-DOC und die Organisation und das Stylen unserer Dokumente ist ebenfalls eine Aufgabe, die ich übernommen bzw. mit Lara Kammerer teilen durfte.

image:img/raymond/git_commits.png[]

Insgesamt habe ich 118 Commits gemacht, 27.753 Codezeilen hinzugefügt und 11.348 Zeilen entfernt. Am intensivsten habe ich im Februar, etwa einen Monat vor der Abgabe-Deadline der Diplomarbeit, gearbeitet.

==== Stundenübersicht
Das folgende Diagramm stellt meine Zeiteinteilung bildlich dar.

// TODO: Tortendiagramm Stundenverteilung einfügen

Ich habe insgesamt 267 Stunden geleistet. Die Hälfte der geleisteten Stunden wurden in die Implementierung der Webapplikation investiert. Die andere Hälfte setzt sich aus fünf Teile zusammen. Darunter wurden 39,5 Stunden in Besprechungen, 31,25 Stunden in der Fertigstellung der Vorstudie, 27,75 Stunden in allgemeine Dokumentenerstellung, 24 Stunden in dem individuellen Teil und schließlich 9 Stunden im Konzeptpapier und im Projektantrag investiert.

==== Persönliches Fazit
Im Rückblick würde ich das Projekt als einen guten Erfolg bezeichnen. Zwar konnten wir nicht alles, was wir geplant hatten, umsetzen, jedoch wurden die wichtigsten Teile des Projekts erfolgreich umgesetzt und getestet. Die Webapplikation sieht sowohl auf Desktop als auch auf mobilen Geräten schön aus, es funktioniert wie gewünscht und kann für die vorgesehenen Zwecke genutzt werden.

Ich konnte Dank meiner beruflichen Erfahrung in der Webentwicklung agil und effizient arbeiten. Unsere Sprints verliefen immer sehr gut, da wir unsere Ziele bis zum Sprint-Ende immer erreichen konnten. Während der Umsetzungsphase durfte ich meine Team-Mitglieder öfters unterstützten, allerdings lernten sie schnell komplexe Aufgaben eigenständig zu erledigen. Dadurch entwickelte sich innerhalb kürzester Zeit eine effiziente Kooperation zwischen uns, was den Entwicklungsprozess viel beschleunigt hat.

Trotz der Erfahrung und dem Wissen vor dem Projektanfang gab es Hürden und Schwierigkeiten, die ich schließlich durch Hartnäckigkeit überwinden konnte. Ich habe in dieser Zeit viel über tRPC gelernt und im Projekt angewandt. Darüber hinaus habe ich gelernt, besser zu kommunizieren und dadurch bessere Zusammenarbeit innerhalb des Teams zu erschaffen. Teamarbeit hat anfangs gefehlt, aber sie entwickelte sich desto schneller umso wir miteinander geredet und unsere Ideen miteinander geteilt haben.

Wenn ich unsere ganze Anstrengung in einem Wort zusammenfassen musste, dann wäre es "Kommunikation". Kommunikation stellte sich während der Projektumsetzung sowohl als größte Schwierigkeit als auch die größte Antriebskraft heraus. Deshalb würde ich zusammenfassend sagen, dass ich sehr dankbar bin, während dieser Diplomarbeit gut kommunizieren gelernt zu haben.
