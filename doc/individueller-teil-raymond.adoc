...
===== Django
Django ist ein WebFramework für die Programmiersprache Python, das 2005 von Django Software Foundation veröffentlicht wurde und von derselben Non-Profit-Organisation heutzutage gepflegt wird.
...
====== Persönliche Erfahrung
 - Express.js: Express ist eines der bekanntesten WebFrameworks und basiert auf Node. Alle Mitglieder durften im Unterricht Erfahrung mit Express sammeln, allerdings ist kein Mitglied besonders gut vertraut mit dem Framework, weshalb die Note 2 vergeben wird.
 - ASP .NET Core: Obwohl ASP .NET Core auch zu den beliebten WebFrameworks gehört, hat nur ein Mitglied damit Erfahrung auf einem grundlegenden Niveau. Dementsprechend wird die Note 4 vergeben.
...
- SOAP: SOAP wurde im Jahr 1999 vom Wide WebKonsortium eingeführt. Wenn wir XML-RPC nicht berücksichtigen, ist diese API-Architektur die älteste aus der Gruppe. Deshalb wird die Note 5 vergeben.
...
//TODO Denis: Erklärung der Daten

==== Persönliches Fazit
//TODO Denis: Fazit schreiben
