...
//TODO Lara: alle verweise auf bild und dergleichen anpassen
...
In Figure 4 wird der Table Editor gezeigt. Hier kann durch Betätigen des Buttons "New Table" eine Tabelle händisch in der GUI erzeugt werden.
